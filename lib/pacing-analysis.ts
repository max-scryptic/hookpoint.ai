          ...
          content: [
            {
              ...
              text: [
                ...
                "This video is already published, so its edit cannot be changed. Write every suggestion as forward-looking guidance for the uploader's next videos (for example 'next time, ...' or 'in future videos, ...'), describing what to do instead of what they did here. Never tell them to re-edit, re-cut, trim, reshoot or re-upload this video, and never suggest comparing an alternate version against the current one.",
