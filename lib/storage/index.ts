...
export interface StorageProvider {
  ...
  // Uploads bytes generated by this server (e.g. an ffmpeg-extracted thumbnail
  // or audio clip) directly to `path`. Unlike putObjectFromUrl, there is no
  // external URL to pull from — the caller already holds the data in memory.
