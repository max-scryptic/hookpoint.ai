...
// The Retention / Packaging / Script tab shell for Channel Trends. The page is a
// server component and the tab bodies are server-rendered, so they are passed in
// as props and this thin client wrapper only owns the tab state. Icons match the
